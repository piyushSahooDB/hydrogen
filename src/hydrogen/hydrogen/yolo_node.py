...
class ImageCollector(Node):
    def __init__(self):
        ...
        self.model = YOLO("/home/piyush/hydrogen/src/hydrogen/model/best.pt")   # ADDED (load your trained YOLO model)
    ...
    def listener_callback(self, msg):
        try:
            ...
            # Show detection
            cv2.imshow("YOLO Detection", annotated_frame)   # CHANGED
            cv2.waitKey(1)                                   # ADDED
